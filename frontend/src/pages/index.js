         ...
         <div className='w-screen h-screen'>
            <div className='grid grid-cols-6 grid-rows-4 w-screen h-screen'>
              ...
              <div className='col-start-1 col-end-5 row-start-1 row-end-2'>
                <h1 className='bg-gray text-eggshell py-5 px-5 font-titlefont font-black laptop:text-9xl tablet:text-3xl'>Routourist</h1>
              </div>
              ...
              <div className='col-start-1 col-end-4 row-start-2 row-end-3 ml-5 my-auto flex flex-col gap-5'>
                <h1 className='text-gray font-titlefont font-black text-8xl'>Navigating just got simpler.</h1>
                <p className='my-2 font-bodyfont text-xl'>From one location to another to another and another</p>
              </div>
          ...
          <div className='w-screen h-min-20 bg-green z-10'>
            ...
            <div className='flex mx-5 content-baseline'>
              ...
              <div className='basis-3/5 my-auto'>
                ...
                <h2 className='font-titleFont font-bold text-6xl text-eggshell'>Got a date you need to plan for?</h2>
                <h2 className='font-titleFont font-bold text-6xl text-eggshell'>Perhaps you want to explore?</h2>
                <h2 className='font-titleFont font-bold text-6xl text-eggshell'>Maybe deliver some packages?</h2>
                <h2 className='font-titleFont font-black text-7xl text-eggshell'>We got you.</h2>
              </div>
...
<p className='ml-5 font-bodyfont font-medium text-xl text-eggshell pb-20'>Its as simple as that!</p>
            </div>
          ...
          <div className='h-screen '>
            <div className='py-10 mx-5'>
              ...
              <h2 className='font-titleFont font-bold text-6xl text-gray'>Provide a convenient routing service that aims to be sustainable and promote other businesses</h2>
            </div>

            <div className='flex gap-10 mx-10 grid-flow-row font-bodyfont'>
