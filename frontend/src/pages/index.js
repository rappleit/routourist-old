          ...
          <button className='rounded-full w-10 h-10 bg-green text-gray shadow-md mx-5'><PlayArrowRoundedIcon></PlayArrowRoundedIcon></button>
            <div className='grid grid-cols-8 grid-rows-2 gap-1 w-screen h-screen'>
              ...
              <div className='col-span-2 row-span-1 justify-center'>
                <button className='font-medium font-bodyfont rounded-full w-20 h-10 bg-gray text-eggshell shadow-md self-center hover:bg-green hover:text-eggshell'>Login</button>
                <button className='font-medium font-bodyfont rounded-full w-20 h-10 bg-eggshell text-gray ml-4 shadow-md self-center hover:bg-green hover:text-eggshell'>Sign Up</button>
              </div>
            </div>
          </div>
